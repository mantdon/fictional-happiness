...
class RegistrationType extends AbstractType
{
    ...
    {
        $builder
            ->add('email', EmailType::class, array('label' => 'El-paštas', 'attr' => array('class' => 'textField', 'style' => 'margin-bottom:15px')))
            ->add('plainPassword', RepeatedType::class, array(
                'type' => PasswordType::class,
                'first_options' => array('label' => 'Slaptažodis', 'attr' => array('class' => 'textField', 'style' => 'margin-bottom:15px')),
                'second_options' => array('label' => 'Pakartoti slaptažodį', 'attr' => array('class' => 'textField', 'style' => 'margin-bottom:15px')),
            ...
            ->add('submit', SubmitType::class, array('label' => 'Registruotis', 'attr' => array('class' => 'button', 'style' => 'margin-bottom:15px')));
    }
